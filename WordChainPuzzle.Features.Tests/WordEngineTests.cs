...
namespace WordChainPuzzle.Feature.Tests
{
    ...
    public class WordEngineTests
    {
        ...
        [TestCase("fair", "gulp")]
        public void GetWordChain_FairToGulp_ReturnsTrue(string firstWord, string lastword)
        {
            var words = _wordengine.GetWordChain(firstWord, lastword);
            Console.WriteLine(String.Join(",", words));
            Assert.AreEqual(5, words.Count);
        ...
        [TestCase("grill", "react")]
        public void GetWordChain_Grilltoreact_ReturnsTrue(string firstWord, string lastword)
        {
            var words = _wordengine.GetWordChain(firstWord, lastword);
            Console.WriteLine(String.Join(",", words));
            Assert.AreEqual(5, words.Count);
        ...
        [TestCase("sporty", "creates")]
        public void GetWordChain_SportyToCreates_ReturnsTrue(string firstWord, string lastword)
        {
            var words = _wordengine.GetWordChain(firstWord, lastword);
            Console.WriteLine(String.Join(",", words));
            Assert.AreEqual(5, words.Count);
